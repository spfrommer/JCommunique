...
public class WindowNotificationTest {
	...
	private class ClickNotification extends WindowNotification {
		public void simulateClick() {
			...
			setPanel(panel);
			MouseEvent me = new MouseEvent(panel, MouseEvent.MOUSE_CLICKED,
	...
	public void windowThemeShouldApply() {
		...
		assertEquals("Window foreground should equal theme foreground", theme.foreground, 
					 note.getInternalWindow().getForeground());
		assertEquals("Window background should equal theme background", theme.background, 
					 note.getInternalWindow().getBackground());
	}
